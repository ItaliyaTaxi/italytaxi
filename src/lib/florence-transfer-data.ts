...
export const flDestinations: FLDestination[] = [
    ...
    {
        slugPart: 'accademia-gallery', name: 'Accademia Gallery', kind: 'landmark',
        area: 'San Marco (historic centre)', type: 'Landmark drop-off',
        description: 'The Galleria dell\'Accademia is world-famous as the home of Michelangelo\'s original David, alongside his unfinished Prisoners and a notable collection of Florentine painting. It sits in the San Marco quarter just north of the Duomo, deep inside the pedestrian ZTL, so a licensed transfer drops you at the nearest permitted point for the short walk to the entrance.',
        dining: 'Florence\'s most visited gallery after the Uffizi, surrounded by the cafés and university streets of the San Marco district.',
        suitedFor: 'travellers whose visit centres on Michelangelo\'s David and the Accademia',
        nearby: [{ place: 'Florence Cathedral (Duomo)', note: '8 min walk' }, { place: 'Piazza San Marco', note: '3 min walk' }, { place: 'Mercato Centrale', note: '7 min walk' }],
        attractions: ['Michelangelo\'s David', 'San Marco Museum', 'Duomo', 'Mercato Centrale'],
        legs: { flr: FLR_CENTRAL },
    },
    {
        slugPart: 'piazza-della-signoria', name: 'Piazza della Signoria', kind: 'landmark',
        area: 'Florence historic centre', type: 'Landmark drop-off',
        description: 'Piazza della Signoria is Florence\'s civic heart, an open-air sculpture gallery dominated by the Palazzo Vecchio, the Loggia dei Lanzi and a copy of Michelangelo\'s David on the spot where the original once stood. The square adjoins the Uffizi and is entirely pedestrian within the ZTL, so your driver brings you to the closest permitted access with help for your bags.',
        dining: 'The political and social stage of Florence for centuries, ringed by historic cafés beside the Palazzo Vecchio.',
        suitedFor: 'travellers staying near the civic centre or starting at the Palazzo Vecchio and Uffizi',
        nearby: [{ place: 'Palazzo Vecchio', note: 'on the square' }, { place: 'Uffizi Gallery', note: '2 min walk' }, { place: 'Ponte Vecchio', note: '5 min walk' }],
        attractions: ['Palazzo Vecchio', 'Loggia dei Lanzi', 'Uffizi Gallery', 'Ponte Vecchio'],
        legs: { flr: FLR_CENTRAL },
    },
    {
        slugPart: 'basilica-of-santa-croce', name: 'Basilica of Santa Croce', kind: 'landmark',
        area: 'Santa Croce (historic centre)', type: 'Landmark drop-off',
        description: 'The Basilica of Santa Croce is the largest Franciscan church in the world and the burial place of Michelangelo, Galileo, Machiavelli and other Italian greats, earning it the nickname the "Temple of the Italian Glories". It fronts the wide Piazza Santa Croce in the eastern historic centre, within the ZTL, so a licensed transfer sets you down at the nearest permitted point.',
        dining: 'A grand Gothic basilica on a lively square known for leather workshops and traditional Florentine trattorias.',
        suitedFor: 'travellers drawn to Florence\'s monumental tombs, frescoes and the Santa Croce quarter',
        nearby: [{ place: 'Piazza Santa Croce', note: 'on the square' }, { place: 'Bargello Museum', note: '6 min walk' }, { place: 'Piazza della Signoria', note: '8 min walk' }],
        attractions: ['Santa Croce basilica', 'Bargello', 'Sant\'Ambrogio market', 'Piazza della Signoria'],
        legs: { flr: FLR_CENTRAL },
    },
    {
        slugPart: 'boboli-gardens', name: 'Boboli Gardens', kind: 'landmark',
        area: 'Oltrarno (behind Palazzo Pitti)', type: 'Landmark drop-off',
        description: 'The Boboli Gardens are a vast Renaissance park behind the Palazzo Pitti, laid out for the Medici and filled with fountains, grottoes, sculpture and terraced avenues with sweeping views over Florence. They lie on the Oltrarno bank just across the river from the centre, an easy drop-off by car for the Pitti and garden complex.',
        dining: 'One of the earliest and most influential Italian gardens, a green retreat above the Oltrarno beside the Pitti Palace.',
        suitedFor: 'travellers visiting the Pitti Palace and gardens or staying in the Oltrarno',
        nearby: [{ place: 'Palazzo Pitti', note: 'at the entrance' }, { place: 'Ponte Vecchio', note: '8 min walk' }, { place: 'Piazzale Michelangelo', note: '12 min walk' }],
        attractions: ['Boboli Gardens', 'Palazzo Pitti', 'Bardini Garden', 'Piazzale Michelangelo'],
        legs: { flr: FLR_CENTRAL_SOUTH },
    },
];
