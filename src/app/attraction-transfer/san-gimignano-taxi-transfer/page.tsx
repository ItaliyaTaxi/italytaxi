...
export const metadata: Metadata = {
  title: "Private Transfer to San Gimignano Towers | Italian Taxi Service",
  ...
  alternates: {
    canonical: "https://www.italytaxiservice.com/attraction-transfer/san-gimignano-taxi-transfer",
  }
};
