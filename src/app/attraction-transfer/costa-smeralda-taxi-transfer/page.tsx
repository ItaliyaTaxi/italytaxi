...
export const metadata: Metadata = {
  title: "Costa Smeralda | Private Taxi Transfer",
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto py-24 px-6 md:px-32">
        <h1 className="text-4xl md:text-6xl font-bold text-navy mb-12">Private Transfer to Costa Smeralda</h1>
        
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-navy mb-6">Visit Costa Smeralda with Ease</h2>
          <p className="text-gray-600 text-lg leading-relaxed">Book a professional private transfer to Costa Smeralda. Avoid the crowds of public transport and enjoy a comfortable ride directly to one of Italy's most iconic locations.</p>
        </section>

        <section className="mb-12 p-8 bg-gray-50 border border-gold/10 rounded-[2.5rem] shadow-sm">
          <h2 className="text-2xl font-semibold text-navy mb-6">Transfer Services to Costa Smeralda</h2>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">Our drivers are locals who know the best routes and can provide tips for your visit to Costa Smeralda. Whether you're traveling solo or in a group, we have the right vehicle for your needs.</p>
        </section>
