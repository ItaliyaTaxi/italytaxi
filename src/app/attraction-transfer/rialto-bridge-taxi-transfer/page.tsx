...
export const metadata: Metadata = {
  title: "Private Transfer to Rialto Bridge | Italian Taxi Service",
  ...
  alternates: {
    canonical: "https://www.italytaxiservice.com/attraction-transfer/rialto-bridge-taxi-transfer",
  }
};
  ...
  return (
    <main className="min-h-screen">
      ...
      <div className="container mx-auto py-24 px-6 md:px-32">
        <h1 className="text-4xl md:text-6xl font-bold text-navy mb-12">Private Transfer to Rialto Bridge</h1>
        
        <section className="mb-12">
          <h2 className="text-2xl font-semibold text-navy mb-6">Visit Rialto Bridge with Ease</h2>
          <p className="text-gray-600 text-lg leading-relaxed">Book a professional private transfer to Rialto Bridge. Avoid the crowds of public transport and enjoy a comfortable ride directly to one of Italy's most iconic locations.</p>
        </section>

        <section className="mb-12 p-8 bg-gray-50 border border-gold/10 rounded-[2.5rem] shadow-sm">
          <h2 className="text-2xl font-semibold text-navy mb-6">Transfer Services to Rialto Bridge</h2>
        ...
        <section className="mb-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed">Our drivers are locals who know the best routes and can provide tips for your visit to Rialto Bridge. Whether you're traveling solo or in a group, we have the right vehicle for your needs.</p>
        </section>
