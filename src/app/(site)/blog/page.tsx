...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/blog",
    // Reciprocal to /it/blog's hreflang back to here — without this, Ahrefs/
    // Google flag a missing return-tag between the two hub pages.
    languages: { 'it-IT': `${SITE}/it/blog`, 'en': `${SITE}/blog`, 'x-default': `${SITE}/blog` },
  }
};
